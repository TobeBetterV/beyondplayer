...
class WindowButtons extends PureComponent {
    state = {
        keyAltDown: false,
    ...
    renderMac() {
        ...
        return (
            <Controls key="title-controls">
                ...
                <ButtonMacMaximize showMaximize={keyAltDown} tabIndex="-1" onClick={this.handleMaximize}>
    ...
    renderWindows() {
        ...
        return (
            <Controls key="title-controls">
                <ButtonWindows aria-label="minimize" tabIndex="-1" onClick={this.handleMinimize}>
                    <svg version="1.1" aria-hidden="true" width="10" height="10">
                        <path d="M 0,5 10,5 10,6 0,6 Z" />
                    </svg>
                </ButtonWindows>
                <ButtonWindows aria-label="maximize" tabIndex="-1" onClick={this.handleMaximize}>
                    {isMaximized ? (
                        <svg version="1.1" aria-hidden="true" width="10" height="10">
                ...
                <CloseButtonWindows aria-label="close" tabIndex="-1" onClick={this.handleClose}>
