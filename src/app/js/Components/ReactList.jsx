...
export default class ReactList extends Component {
    ...
    setScroll(offset, anim) {
        ...
        if (anim) {
            this.startOffset = scrollParent[SCROLL_START_KEYS[axis]];
    ...
    loopMove = timestamp => {
        ...
        this.scrollParent.scrollTop = lerp(this.startOffset, this.targetOffset, progress / ANIM_TIME);
    ...
    getItemSizeAndItemsPerRow() {
        ...
        itemsPerRow = 1;
        for (let item = itemEls[itemsPerRow]; item && item[startKey] === firstStart; item = itemEls[itemsPerRow]) ++itemsPerRow;
    ...
    scrollTo(index, anim) {
        if (index != null) this.setScroll(this.getSpaceBefore(index), anim);
    }
